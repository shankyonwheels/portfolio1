...
// We can use the original logos or replace them with recruiting-related ones if they exist, but we'll stick to original for now.
const imageUrls = [
  "/images/react2.webp",
  "/images/next2.webp",
  "/images/node2.webp",
...
const BouncingSkills = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const thresholdElement = document.getElementById("skills");
      if (thresholdElement) {
        const threshold = thresholdElement.getBoundingClientRect().top;
        setIsActive(scrollY > threshold - 500); // active slightly before reaching it
      } else {
